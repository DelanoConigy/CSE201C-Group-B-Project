...
public class BalanceBeam extends Room {
    ...
    public void loadSkills() {
        Move one = new Move("Leap", 1, "A mount that involves leaping from the ground onto the beam, landing on one foot.");
        Move two = new Move("Cartwheel", 2, "A mount that involves a running start into a cartwheel onto the beam.");
        Move three = new Move("Front tuck", 3, "A mount that involves a running start and a front tuck on to the beam, landing on two feet.");
        Move four = new Move("Cartwheel", 1, "A simple cartwheel across the beam.");
        Move five = new Move("Roundoff", 2, "This move is similar to the cartwheel, but the gymnast lands with both feet together on the beam.");
        Move six = new Move("Free Aerial", 3, "This move is similar to the cartwheel, but the gymnast's hand do not touch the beam.");
        Move seven = new Move("Pike Front Tuck", 1, "This combination of a tuck and a pike has the gymnast flip forward while keeping their legs straight.");
        Move eight = new Move("Tuck Side Salto", 2, "The gymnast starts facing forward and flips sideways, facing the side at the conclusion of the skill.");
        Move nine = new Move("Tucked Arabian Salto", 3, "The gymanst jumps high into the air, performs a half turn, then tucks themselves in to finish the flip.");
        Move ten = new Move("Half Illusion Turn", 1, "The gymnast steps one foot out and while bending down towards that foot swings the other leg above and around, finishing the turn.");
        Move eleven = new Move("Double turn in tuckstand", 2, "The gymnast crouches down on the beam and performs 2 consecutive turns with one leg and both arms extended.");
        Move twelve = new Move("Triple turn on one foot", 3, "While standing on one foot, the gymnast completes 3 full spins.");
        Move thirteen = new Move("Pike Jump", 1, "Starting on two feet, the gymnast jumps with both legs extended forward.");
        Move fourteen = new Move("Straddle Jump with Half Turn", 2, "The gymnast will rotate 180 degrees while jumping with both legs extended out to opposite sides.");
        Move fifteen = new Move("Split Jump with Body Arched and Head Dropped", 3, "The gymnast will jump. While doing so, they extend one leg back and arch their back until their head touches their leg.");
        Move sixteen = new Move("Forward Roll", 1, "The gymnast performs a forward roll on the beam without hand support.");
        Move seventeen = new Move("Back Extension", 2, "Starting from a handstand position, the gymnast moves down to straddle the beam and then performs a back roll into a handstand.");
        Move eighteen = new Move("Back Handspring", 3, "The gymnast flips backward across the beam, touching their hands to the beam midway through the movement.");
    ...
    public int calculatePerformance(int difficulty, int skillLevel, int confidence) {
        ...
        //System.out.println("total: " + skillLevel + " + " + confidence + " + " + randomNum + " = " + total);
        return total;
    }
