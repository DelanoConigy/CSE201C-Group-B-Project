 ...
 * This class extends Room and includes move requirements and minigame triggers
...
public class PommelHorse extends Room {
     ...
     * and moves. Triggers minigames if the player does not meet the skill
    ...
    /**
     * Prompts the player to choose a position on the pommel horse (left,
     * middle, right).
     */
     ...
     * Displays available moves and prompts the player to select one.
     *
    ...
    /**
     * Number guessing minigame where the player has three attempts to guess a
     * randomly generated number between 1 and 5.
     *
    ...
    /**
     * Reaction time minigame where the player must type "GO!" as fast as they
     * can after a randomized delay.
     *
     * @param player the Player object participating in the minigame
    ...
    /**
     * Performs a challenging combo move with a predefined sequence. Awards
     * higher confidence upon successful completion.
     *
